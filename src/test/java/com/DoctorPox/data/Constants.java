...
public class Constants {
    ...
    //测试App的启动入口
    public static final String APP_INDEX = "com.xcgl.dbs.ui.main.view.MainActivity";
    ...
    //正确的登录账号
    public static final String CORRECT_PHONE = "17648751475";
    //正确的登录密码
    public static final String CORRECT_CAPTCHA = "234545";
    //什么时候去预定呀，时间
    public static final String CORRECT_DATE = "2021-10-24 00";
